%% cpsd_to_var_ver
%
% ORIGINAL VERSION (see core/cpsd_to_var)
%
...
%% Syntax
%
%     [H,V,converged,iters,mre] = cpsd_to_var_ver(S,maxiters,numtol,verb)
%
%% Arguments
%
...
function [H,V,converged,iters,mre] = cpsd_to_var_ver(S,maxiters,numtol,verb)
